...
func (dc *defaultCodec) Encode(typ int, v interface{}) (interface{}, error) {
	if v == nil {
		return nil, nil
	}
...
func (dc *defaultCodec) Decode(typ int, src interface{}, dest []interface{}) (err error) {
	if len(dest) == 0 {
		return nil
	}
